...
public class FaceDetector {
    ...
    public void loadEngine() {
        ...
        loadEngine(getPath("face_detector.csta", mContext), getPath("face_landmarker_pts68.csta", mContext));
//        loadEngine(getPath("face_detector.csta", mContext), getPath("face_landmarker_mask_pts5.csta", mContext));
