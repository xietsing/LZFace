package com.xmlenz.lzface.seeta;
...
import com.xmlenz.lzface.MyApp;
...
//        loadEngine(getPath("fd_2_00.dat"), getPath("pd_2_00_pts5.dat"), getPath(""));//"SeetaFaceRecognizer2.0.ats"));//
        loadEngine(getPath("face_detector.csta"), getPath("face_landmarker_pts5.csta"),getPath("face_recognizer_light.csta"));
    }
    ...
    public static String getPath(String file) {
        ...
        try {
            ...
            inputStream.close();
            File outFile = new File(MyApp.getInstance().getFilesDir(), file);
